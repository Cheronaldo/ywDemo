...
public class DeviceVerifyRepositoryTest {
    ...
    @Test
    public void findFirstBySnCodeOrderByIdDesc() throws Exception{

        DeviceVerify result = deviceVerifyRepository.findFirstBySnCodeOrderByIdDesc("1510917580195286976");
